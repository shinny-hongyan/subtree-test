    ...
    data () {
      return {
        ...
        columnsAppend: [{
          ...
          width: '80',
          key: 'margin_long',
          cb: d => d.margin_long.toFixed ? d.margin_long.toFixed(2) : d.margin_long
        }, {
          name: '空仓',
          key: 'volume_short',
          width: '60',
          ...
          width: '80',
          key: 'margin_short',
          cb: d => d.margin_short.toFixed ? d.margin_short.toFixed(2) : d.margin_short
        }],
        ordersTr: {}
      }
    },
    ...
    mounted () {
      ...
      this.$tqsdk.on('rtn_data', function(){
        ...
        for(let symbol in positions){
          if (positions[symbol]._epoch === self.$tqsdk.dm._epoch) {
